...
//MOTOR
void drehen(){   
int dreh = currentstate - futurestate; // Abstand zwischen Schritt IST und Schritt SOLL
if (dreh > 0){
  digitalWrite(dirPin,HIGH); //Wenn "dreh" positiv ist dann soll der zurück drehen
  
for(int x = 0; x<dreh; x++) {  //Motor dreht sich um den Abstand der Schritte
...
else if (dreh < 0){         //Wenn "dreh" negativ ist dann soll der zurück drehen
  dreh = dreh * -1;       //Wenn "dreh" negativ wird er positiv gemacht für die Schrittanzahl
